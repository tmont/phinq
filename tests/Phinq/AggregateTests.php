...
class AggregateTests extends \PHPUnit_Framework_TestCase {
	...
	public function testMax() {
		...
		self::assertEquals(3, Phinq::create($collection)->max(function($value) {
	...
	public function testMaxWithNonNumbers() {
		...
		self::assertSame($obj1, Phinq::create($collection)->max(function($value) {
			return $value->id;
		}));
	}
	...
	public function testMaxWithDuplicateValues() {
		...
		self::assertSame($obj3, Phinq::create($collection)->max(function($value) {
			return $value->id;
		}));
	}
	...
	public function testMin() {
		...
		self::assertEquals(6, Phinq::create($collection)->min(function($value) {
			return $value > 3 ? 0 : $value;
		}));
	}
	...
	public function testMinWithDuplicateValues() {
		...
		self::assertSame($obj3, Phinq::create($collection)->min(function($value) {
			return $value->id;
		}));
	}
	...
	public function testMinWithNonNumbers() {
		...
		self::assertSame($obj2, Phinq::create($collection)->min(function($value) {
			return $value->id;
		}));
	}
	...
	public function testAverage() {
		...
		self::assertEquals(7, Phinq::create($collection)->average(function($value) {
			return $value * 2;
		}));
	}
	...
	public function testSum() {
		...
		self::assertEquals(42, Phinq::create($collection)->sum(function($value) {
			return $value * 2;
		}));
	}
