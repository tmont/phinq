...
class RetrievalTests extends \PHPUnit_Framework_TestCase {
	...
	public function testFirstWithFilter() {
		self::assertSame(4, Phinq::create(array(1, 2, 3, 4, 5, 6))->first(function($value) {
			return $value > 3;
		}));
	}
	...
	public function testFirstOrDefaultWithFilter() {
		self::assertSame(4, Phinq::create(array(1, 2, 3, 4, 5, 6))->firstOrDefault(function($value) {
			return $value > 3;
		}));
	}
	...
	public function testSingleWithFilter() {
		self::assertSame(6, Phinq::create(array(1, 2, 3, 4, 5, 6))->single(function($value) {
			return $value > 5;
		}));
	}
	...
	public function testSingleOrDefaultWithFilter() {
		self::assertSame(6, Phinq::create(array(1, 2, 3, 4, 5, 6))->singleOrDefault(function($value) {
			return $value > 5;
		}));
	}
	...
	public function testLastWithFilter() {
		self::assertSame(2, Phinq::create(array(1, 2, 3, 4, 5, 6))->last(function($value) {
			return $value < 3;
		}));
	}
	...
	public function testLastOrDefaultWithFilter() {
		self::assertSame(2, Phinq::create(array(1, 2, 3, 4, 5, 6))->lastOrDefault(function($value) {
			return $value < 3;
		}));
	}
