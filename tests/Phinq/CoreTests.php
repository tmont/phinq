...
class CoreTests extends \PHPUnit_Framework_TestCase {
	...
	public function testToDictionary() {
		...
		$dictionary = Phinq::create(range(1, 3))->toDictionary(function($int) use ($keys) {
			return $keys[$int - 1];
		});
	...
	public function testAll() {
		$collection = range(1, 6);
		self::assertTrue(Phinq::create($collection)->all(function($value) {
			return is_int($value);
		}));
		self::assertFalse(Phinq::create($collection)->all(function($value) {
			return $value < 6;
		}));
	}

	public function testAllWithEmptyCollection() {
		self::assertTrue(Phinq::create(array())->all(function($value) {
			return true;
		}));
		self::assertTrue(Phinq::create(array())->all(function($value) {
			return false;
	...
	public function testAnyWithPredicate() {
		self::assertTrue(Phinq::create(range(1, 6))->any(function($value) {
			return $value === 3;
		}));
		self::assertFalse(Phinq::create(array())->any(function($value) {
			return $value !== null;
		}));
	}
	...
	public function testCountWithPredicate() {
		self::assertSame(2, Phinq::create(array(1, 2, 3))->count(function($value) {
			return $value < 3;
		}));
		self::assertSame(0, Phinq::create(array(1, 2, 3))->count(function($value) {
			return false;
		}));
		self::assertSame(3, Phinq::create(array(1, 2, 3))->count(function($value) {
			return true;
		}));
	}
